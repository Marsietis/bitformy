...
class FormController extends Controller
{
    ...
    public function regenerateLink(Form $form)
    {
        ...
        // Create a new form record (UUID will be auto-generated by the model)
        $newForm = Form::create([
        ...
        // Get the auto-generated UUID from the new form
        $newId = $newForm->id;

        // Now update all questions to point to the new form ID
        $form->questions()->update(['form_id' => $newId]);
        
        // Update all answers to point to the new form ID
        $form->answers()->update(['form_id' => $newId]);

        // Delete the old form record (this won't cascade delete questions/answers since we updated their form_id)
